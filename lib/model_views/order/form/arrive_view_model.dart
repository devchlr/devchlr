...
double getDistance(OrderRecipientInformation? recipient,OrderDeliveryInformation? departure){
  ...
  formEditingController(BuildContext context)async{
  ...
  if(validatorForm(context)){
    ...
    double distance=km_distance;
    print(distance);
    Navigator.push(context,
        new MaterialPageRoute(
            builder: (BuildContext context) =>
            new TailleColisScreen(deliveryInformation:orderDeliveryInformation,recipientInformation:recipientInformation,km_distance: distance,)));
    }
  }
}